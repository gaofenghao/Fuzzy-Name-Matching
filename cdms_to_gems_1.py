# -*- coding: utf-8 -*-
"""
Created on Tue Jun 27 12:33:20 2017
...
full_universe = pd.read_excel('H:/Client Name Truth/Data/Copy of FULL_UNIVERSE 6-19-17.xlsx')

cdms_unmatched = pd.read_excel('H:/Client Name Truth/Data/CDMS_TO_GEMS_MASTER_06_26_2017.xlsx', sheetname = 'UNMATCHED')
...
#load GEMS
GEMS_UNIVERSE = pd.read_excel('H:/Client Name Truth/Data/Copy of FULL_UNIVERSE 6-19-17.xlsx')
...
cdms_save = pd.read_excel('H:/Client Name Truth/Data/CDMS_TO_GEMS_MASTER_06_26_2017.xlsx', sheetname = 'UNMATCHED')
